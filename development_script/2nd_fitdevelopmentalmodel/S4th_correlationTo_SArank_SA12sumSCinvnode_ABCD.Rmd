...
if (CVthr == 75){
  ...
  mytheme <- theme(axis.text=element_text(size=21.2, color="black"), 
...
if (CVthr==25){
  mytheme <- theme(axis.text=element_text(size=21.5, color="black"), 
        axis.title =element_text(size=21.5),aspect.ratio = 0.75,
        axis.line = element_line(linewidth=0.6),axis.ticks= element_line(linewidth=0.6),
        plot.title = element_text(size=20, hjust = 0.5, vjust=2),
        plot.background=element_rect(fill="transparent"),
        panel.background=element_rect(fill="transparent"),
