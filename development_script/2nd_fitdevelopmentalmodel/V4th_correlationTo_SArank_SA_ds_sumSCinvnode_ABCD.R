...
#### load data
CVthr = 75
gamresult_noscale<-readRDS(paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_siteall_CV', CVthr,'.rds'))
...
# 1            17  partialRsq2 -0.6094658 1.606364e-16
# 2            17    meanderv2  0.7468885 1.504268e-28

# matrix  of 7
#   ds.resolution Interest.var r.spearman   p.spearman
# 1             7  partialRsq2 -0.8101820   1.748539e-07
# 2             7    meanderv2  0.8829889   5.011980e-10
...
ggplot(data=correlation.df)+
  ...
  scale_y_continuous(breaks = c(-1,-0.5,0,0.5,1.0, 1.5), labels=c(-10,-5,0,5,10, 15))+
  theme_classic()+
