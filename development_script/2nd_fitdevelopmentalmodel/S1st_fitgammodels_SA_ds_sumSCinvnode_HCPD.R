...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  # resolution = 12
  # CV75 64 sig, 15 non-sig ; CV25 52 sig, 26 non-sig
  # resolution = 7
  # CV75 24 sig, 4 non-sig
...
# outputs
#1. gamresults', elementnum, '_over8.rds contains statistic variables from gam models
#2. gammodel', elementnum, '_over8.rds contains elementnum gam model files
#3. plotdatasum.df_SA', ds.resolution,'_sumSCinvnode.rds raw plot data
#4. gammodel', elementnum, '_sumSCinvnode_over8_CV75_scale_TRUE.rds the developmental model of the de-weighted SC strength.
# SC strength were de-weighted by the initial SC strength at age of 8 estimated through gam model.
#5. gamresults', elementnum, '_sumSCinvnode_over8_CV75_scale_TRUE.rds the gam stats estimated using scaled data. 
