...
#### load data
CVthr = 75
gamresult<-readRDS(paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_siteall_CV', CVthr,'_scale_TRUE_validat_',addcovariate,'.rds'))
...
# 1            12  partialRsq2 -0.6831202 7.675393e-12
# 2            12    meanderv2  0.8212353 3.338939e-20

# ICV
# ds.resolution Interest.var r.spearman   p.spearman
# 1            12  partialRsq2 -0.6587883 7.373946e-11
# 2            12    meanderv2  0.8228793 2.427675e-20

# income.adj
# ds.resolution Interest.var r.spearman   p.spearman
# 1            12  partialRsq2 -0.6865248 5.495865e-12
# 2            12    meanderv2  0.8221331 2.806643e-20
...
ggsave(paste0(FigureFolder,'/CV', CVthr, '/correlation_sumSCinvnode_SCrank/mean', computevar, '_SCrankcorr_siteall_',addcovariate,'.tiff'), width=17, height =14, units = "cm")
ggsave(paste0(FigureFolder,'/CV', CVthr, '/correlation_sumSCinvnode_SCrank/mean', computevar, '_SCrankcorr_siteall_',addcovariate,'.svg'), dpi=600, width=17.5, height =15, units = "cm")
...
for (computevar in computevarlist){
  ...
  Fig
  filename<-paste0(FigureFolder,'/CV', CVthr, "/Matrix", ds.resolution, "_sumSCinvnode_gamstats_Age8_22/", computevar, "_delLM_CV", CVthr,"_siteall_',addcovariate,'.tiff")
