...
# 2. Correlation to connectional axis
...
print(paste0(sum(gamresult.tmp$bootstrap_pvalue.fdr<0.05), " edges have significant age by ", int_var, " effect."))
print(paste0(sum(gamresult.tmp$bootstrap.P.disease.fdr<0.05), " edges have significant ", int_var, " effect."))
# SA7: 16 edges have significant general effect.
# SA17: 38 edges have significant general effect.
...
SCrank.tmp <- SCrankcorr(gamresult.tmp, "IntpartialRsq", ds.resolution, perm.id.full, dsdata=T)
SCrank <- SCrank.tmp$SCrank
SCrank.df.whole
# SA7
#  ds.resolution  Interest.var r.spearman   p.spin int_var
#  7 IntpartialRsq  0.3254414 0.136150 general
#  7     T.disease  0.5465992 0.069425 general

# SA17
#  17 IntpartialRsq  0.3531157 0.021000 general
#  17     T.disease  0.2926964 0.090925 general
