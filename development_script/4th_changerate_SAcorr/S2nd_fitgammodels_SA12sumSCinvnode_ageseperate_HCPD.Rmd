...
ggsave(paste0(FigureFolder, '/correlation_sumSCinvnode_SCrank_younger/', computevar, '_SCrankcorr_n', ds.resolution, '.tiff'), width=10, height =8, units = "cm")
...
ggplot(data=correlation.df)+
  ...
  theme(axis.text=element_text(size=15, color="black"), 
        ...
        plot.background=element_rect(fill="transparent"),
        panel.background=element_rect(fill="transparent"), legend.position = "none")
ggsave(paste0(FigureFolder, '/correlation_sumSCinvnode_SCrank_older/', computevar, '_SCrankcorr_n', ds.resolution, '.tiff'), width=10, height =8, units = "cm")
