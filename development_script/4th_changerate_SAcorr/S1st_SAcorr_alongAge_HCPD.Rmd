...
ggplot(data=df.poscorr.diw)+
  ...
  mytheme
ggsave(paste0(FigureFolder,'/CV', CVthr, '/Alignment_development/SA12_posDeriv_divweight_corr.tiff'), width=20, height=15, units="cm")
...
ggplot(data=df.agemerge)+
  ...
  theme(axis.text=element_text(size=15.4, color="black"), 
        axis.title =element_text(size=15.4),aspect.ratio = 0.82,
