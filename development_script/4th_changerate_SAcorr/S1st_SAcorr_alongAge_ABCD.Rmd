...
This script is to generate the alignment between 1st derivatives and connectional axis. Derivatives and posterior derivatives generated from the 2nd step will be used. Figure 5 (g~i), Supplementary Figure 4 (d~e).
...
## 2. plot alignment with SC rank correlation (Figure 5 (h))
```{r plotalignment}
...
ggsave(paste0(FigureFolder,'/CV', CVthr,  '/Alignment_development/SA12_posDeriv_divweight_corr.svg'), width=13.5, height=15, units="cm")

```

## 3.correlation plot at different age (Figure 5 (i))
```{r plot_sep_age}
...
SCrankcorr(df.age8, "derivative", 12, perm.id.full) #r=-0.7318403 0.0096
# CV25 r=-0.6810537 0.011825
...
df.age13 <- df.age13[-1,]
SCrankcorr(df.age13, "derivative", 12, perm.id.full) #r=-0.08635996 0.33405
...
ggsave(paste0(FigureFolder,'/CV', CVthr,  '/Alignment_development/deri.diw_corr_SCrank12ageAll.svg'), dpi=600, width = 14, height = 12, units="cm")
#############################################

### derivative plots (Figure 5 (g))
##################################
