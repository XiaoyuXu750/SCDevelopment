...
model_terms <- c(SC_vars,"subID", "age", "siteID", "sex", "mean_fd", "scanID")
...
describe(dataTable$SC.50_h)
corr.test(comtable$SC.50, dataTable$SC.50_h)
saveRDS(dataTable, paste0(interfileFolder, "/SCdata_SA", resolutionds, "_CV25_sumSCinvnode.sum.msmtcsd.combatNTBfluid_cog2SC.rds"))
