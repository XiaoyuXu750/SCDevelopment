...
## The ID of edges which should be deleted according to consistency threshold will be 
library(R.matlab)
library(mgcv)
library(visreg)
library(ggplot2)
...
SCdata.sum.merge <- SCdata.sum.merge[SCdata.sum.merge$mean_fd<1.44,] # big head motion 14 removed
...
# 70876 variables+subID * 604 observations
#2. SCdata.sum.msmtcsd.merge.rds : 70876 variables + 51 behavior variables + subID * 590 obs
