...
input_rds <- paste0(interfileFolder, '/SCdata_SA12_CV75_sumSCinvnode.sum.msmtcsd.merge.rds')
output_dir <- interfileFolder
test_n = 0

combatgampath = "/ibmgpfs/cuizaixu_lab/xuxiaoyu/SC_development/Rcode_SCdevelopment/development_script/combat_gam/combat_gam"
source(file.path(combatgampath, "longitudinal", "neuroCombat.R"))
source(file.path(combatgampath, "longitudinal", "nonlinearlongcombat.R"))
