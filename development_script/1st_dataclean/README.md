...
## S3rd_combat_gam
We conducted ComBat to harmonize the structural connectivity strength from multiple acquisition sites, referring to a code adapted from [Neuroharmonize](https://github.com/rpomponio/neuroHarmonize.git) and [NonlinearLongCombat](https://github.com/nmd1994/NonlinearLongitudinalComBat.git).
